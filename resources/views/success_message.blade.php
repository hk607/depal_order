			...
			<div class="row">
				...
				<div class="col-md-12 align-self-center">
					...
					<div class="row justify-content-center" id="printableArea">
						...
						<div class="col-12">
							<br>
							<p class="mt-3" style="font-family: 'Oswald', sans-serif; font-weight: 500; font-size:1.7em;">Dear {{$bookingDetail->user->name}} your Order for {{$bookingDetail->order_number}} is Confirmed.
